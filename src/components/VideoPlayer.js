...
export function VideoPlayer() {
  ...
  const {
    state: { notes, likedVideo, watchLater, dislikedVideo },
    dispatch,
  } = useData();
          ...
          <div>
            ...
            <div className="video-player-description">
              ...
              <div className="video-player-flex">
                ...
                {likedVideo && isVideoLiked() ? (
                  <ThumbUpIcon onClick={onlyRemoveFromLikedVideos} />
                ) : (
                  <ThumbUpAltOutlinedIcon onClick={likedButtonHandler} />
                )}
                {dislikedVideo && isVideoDisliked() ? (
                  <ThumbDownIcon onClick={onlyRemoveFromUnLikedVideos} />
                ) : (
                  <ThumbDownOutlinedIcon onClick={dislikeButtonHandler} />
                )}
                {watchLater && isWatchlater() ? (
                  <WatchLaterIcon
                    onClick={() => watchLaterUnClicked(videoId)}
                  />
                ) : (
                  <WatchLaterOutlinedIcon
                    onClick={() => watchLaterClicked(videoId)}
                  />
                )}
              </div>
